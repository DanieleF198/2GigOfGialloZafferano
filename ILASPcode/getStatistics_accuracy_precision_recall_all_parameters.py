...
data_45_couples_no_zeros = np.zeros((48, 5*5, 4), dtype='float32')
...
for choice in choices:
    ...
    for dataset_counter in range(0,3):
        if dataset_counter == 0:
            ...
            # plt.savefig("./Data8Component2Std/all_parameters_variation_graphs/dataset45.jpg", dpi=300)
            ...
            # plt.savefig("./Data8Component2Std/all_parameters_variation_graphs/dataset105.jpg", dpi=300)
        else:
            ...
            plt.savefig("./Data8Component2Std/all_parameters_variation_graphs/dataset210.jpg", dpi=300)
