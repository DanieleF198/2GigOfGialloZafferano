...
for choice in choices:
    ...
    if type_dataset == "_original":
        ...
        plt.savefig("./Data8Component2Std/all_parameters_variation_graphs/original/dataset150.jpg", dpi=300)
    else:
        for dataset_counter in range(0,3):
            if dataset_counter == 0:
                ...
                plt.savefig("./Data8Component2Std/all_parameters_variation_graphs/sampled/dataset210.jpg", dpi=300)
