...
for choice in choices:
    ...
    with open(path, 'w+', encoding='UTF8') as f_output:
        ...
        for COUPLE in COUPLES:
            ...
            for USER in USERS:
                if int(choice) == 0:
                    output_train_data_dir = "./Data8Component2Std/users/no_zero/train/" + str(COUPLE) + "Couples/"
                    ...
                    output_train_data_dir = "./Data8Component2Std/users/zero/train/" + str(COUPLE) + "Couples/"
