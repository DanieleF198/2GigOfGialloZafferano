...
for choice in choices:
    ...
    for USER in USERS:
        if int(choice) == 0:
            train_data_dir = "./Data8Component2Std/final/users/no_zero/train/210Couples/User" + str(USER) + "/"
            # test_data_dir = "./Data8Component2Std/final/users/no_zero/test/105Couples/User" + str(USER) + "/"
        else:
            train_data_dir = "./Data8Component2Std/final/users/zero/train/210Couples/User" + str(USER) + "/"
...
no_zero_data_dir = "./Data8Component2Std/final/users/no_zero/train/210Couples/"
zero_data_dir = "./Data8Component2Std/final/users/zero/train/210Couples/"
