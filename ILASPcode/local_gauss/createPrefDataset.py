...
zero_dir_train = "Data8Component2Std/users/zero/train/210CouplesGaussianNoise/"
no_zero_dir_train = "Data8Component2Std/users/no_zero/train/210CouplesGaussianNoise/"
...
f_preferences_train = os.path.join(NNoutput_dir, 'train/210CouplesGaussianNoise/samples.txt')
f_labels_train = os.path.join(NNoutput_dir, 'train/210CouplesGaussianNoise/labels.txt')
...
couples_dataset_train = np.zeros((len(linesOfPTrain)-1, 190, 2), dtype='int32')
...
couple_label_train = np.zeros((len(linesOfLTrain)-1, 190), dtype='int32')
...
couples_dataset_test = np.zeros((len(linesOfPTest)-1, 190, 2), dtype='int32')
...
couple_label_test = np.zeros((len(linesOfLTest)-1, 190), dtype='int32')
