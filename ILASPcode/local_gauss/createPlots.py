...
for choice in choices:
    ...
    for i, user_matrix in enumerate(data_45_couples_no_zeros):
        if np.all(user_matrix == 0):
            ...
            ax.set_title('user' + str(i) + "-No_zeros-Train_" + str(user_matrix[0, 5]) + "-Test_" + str(user_matrix[0, 6]))
            ax.legend(loc="lower center", ncol=4, prop={'size': 8})
            plt.savefig("./Data8Component2Std/plots/" + part_path + "percentages/45Couple/user" + str(i) +".png", dpi=300)
            ...
            plt.savefig("./Data8Component2Std/plots/" + part_path + "training_time/45Couple/user" + str(i) +".png", dpi=300)
    ...
    for i, user_matrix in enumerate(data_105_couples_no_zeros):
        if np.all(user_matrix == 0):
            ...
            ax.set_title('user' + str(i) + "-No_zeros-Train_" + str(user_matrix[0, 5]) + "-Test_" + str(user_matrix[0, 6]))
            ax.legend(loc="lower center", ncol=4, prop={'size': 8})
            plt.savefig("./Data8Component2Std/plots/" + part_path + "percentages/105Couple/user" + str(i) +".png", dpi=300)
            ...
            ax.set_title('user' + str(i) + "-No_zeros-Train_" + str(user_matrix[0, 5]) + "-Test_" + str(user_matrix[0, 6]))
            ax.legend(loc="lower right")
            plt.savefig("./Data8Component2Std/plots/" + part_path + "training_time/105Couple/user" + str(i) +".png", dpi=300)
    ...
    for i, user_matrix in enumerate(data_210_couples_no_zeros):
        if np.all(user_matrix == 0):
            ...
            ax.set_title('user' + str(i) + "-No_zeros-Train_" + str(user_matrix[0, 5]) + "-Test_" + str(user_matrix[0, 6]))
            ax.legend(loc="lower center", ncol=4, prop={'size': 8})
            plt.savefig("./Data8Component2Std/plots/" + part_path + "percentages/210Couple/user" + str(i) +".png", dpi=300)
            ...
            ax.set_title('user' + str(i) + "-No_zeros-Train_" + str(user_matrix[0, 5]) + "-Test_" + str(user_matrix[0, 6]))
            ax.legend(loc="lower right")
            plt.savefig("./Data8Component2Std/plots/" + part_path + "training_time/210Couple/user" + str(i) +".png", dpi=300)
    ...
    for user_matrix_45, user_matrix_105, user_matrix_210 in zip(data_45_couples_no_zeros, data_105_couples_no_zeros, data_210_couples_no_zeros):
        ...
        ax.set_ylabel('percentage')
        ax.set_title('user' + str(user_counter) + "-45Couples-105Couples-210Couples-No_zeros")
        ax.legend(loc="lower center", ncol=4, prop={'size': 8})
        plt.savefig("./Data8Component2Std/plots/" + part_path + "percentages/AllCouple/user" + str(user_counter) + ".png", dpi=300)
        user_counter += 1
    ...
    for user_matrix_45, user_matrix_105, user_matrix_210 in zip(data_45_couples_no_zeros, data_105_couples_no_zeros, data_210_couples_no_zeros):
        ...
        ax.set_title('user' + str(user_counter) + "-45Couples-105Couples-210Couples-No_zeros")
        ax.legend(loc="lower right")
        plt.savefig("./Data8Component2Std/plots/" + part_path + "training_time/AllCouple/user" + str(user_counter) + ".png", dpi=300)
        user_counter += 1
