            ...
            for choice in choices:
                ...
                for USER in USERS:
                    if int(choice) == 0:
                        ...
                        preferences_train = ilasp.preferencesFromFileSpacesAndSignAndNumber("Data8Component2Std/users/no_zero/train/210CouplesGaussianNoise/user" + str(USER) + ".txt")
                        ...
                        preferences_train = ilasp.preferencesFromFileSpacesAndSignAndNumber("Data8Component2Std/users/zero/train/210CouplesGaussianNoise/user" + str(USER) + ".txt")
