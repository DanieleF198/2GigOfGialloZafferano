...
for choice in choices:
    for scope in scopes:
        for PCAindex in PCAindexes:
            if choice == 1:
                path = './PCAexperiment/testOutput' + scope + str(PCAindex) + '/results_zero_grid_search_all.csv'
            else:
                continue
                # temporally
            ...
            output_accuracy_path = "./PCAexperiment/grid_results" + scope + str(PCAindex) + "/accuracy.txt"
            output_precision_path = "./PCAexperiment/grid_results" + scope + str(PCAindex) + "/precision.txt"
            output_recall_path = "./PCAexperiment/grid_results" + scope + str(PCAindex) + "/recall.txt"
