                ...
                for scope in scopes:
                    for PCAindex in PCAindexes:
                        ...
                        for USER in USERS:
                            if int(choice) == 0:
                                if scope == "_original":
                                    output_train_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/no_zero/train/150Couples/User" + str(USER) + "/trainFiles/"
                                    output_test_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/no_zero/test/50Couples/User" + str(USER) + "/testFiles/"
                                    output_dir_for_train_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/no_zero/train/150Couples/User" + str(USER) + "/outputTrain/"
                                    output_dir_for_test_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/no_zero/test/50Couples/User" + str(USER) + "/outputTest/"
                                    preferences_train = ilasp.preferencesFromFileSpacesAndSign("PCAexperiment/users_original/no_zero/train/150Couples/user" + str(USER) + ".txt")
                                    preferences_test = ilasp.preferencesFromFileSpacesAndSign("PCAexperiment/users_original/no_zero/test/50Couples/user" + str(USER) + ".txt")
                                else:
                                    output_train_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/no_zero/train/105Couples/User" + str(USER) + "/trainFiles/"
                                    output_test_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/no_zero/test/105Couples/User" + str(USER) + "/testFiles/"
                                    output_dir_for_train_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/no_zero/train/105Couples/User" + str(USER) + "/outputTrain/"
                                    output_dir_for_test_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/no_zero/test/105Couples/User" + str(USER) + "/outputTest/"
                                    preferences_train = ilasp.preferencesFromFileSpacesAndSign("PCAexperiment/users_new_version_second/no_zero/train/105Couples/user" + str(USER) + ".txt")
                                ...
                                if scope == "_original":
                                    output_train_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/zero/train/150Couples/User" + str(USER) + "/trainFiles/"
                                    output_test_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/zero/test/50Couples/User" + str(USER) + "/testFiles/"
                                    output_dir_for_train_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/zero/train/150Couples/User" + str(USER) + "/outputTrain/"
                                    output_dir_for_test_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/zero/test/50Couples/User" + str(USER) + "/outputTest/"
                                    preferences_train = ilasp.preferencesFromFileSpacesAndSign("PCAexperiment/users_original/zero/train/150Couples/user" + str(USER) + ".txt")
                                    preferences_test = ilasp.preferencesFromFileSpacesAndSign("PCAexperiment/users_original/zero/test/50Couples/user" + str(USER) + ".txt")
                                else:
                                    output_train_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/zero/train/105Couples/User" + str(USER) + "/trainFiles/"
                                    output_test_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/zero/test/105Couples/User" + str(USER) + "/testFiles/"
                                    output_dir_for_train_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/zero/train/105Couples/User" + str(USER) + "/outputTrain/"
                                    output_dir_for_test_data_dir = "./PCAexperiment/final" + scope + str(PCAindex) + "/users/zero/test/105Couples/User" + str(USER) + "/outputTest/"
                                    preferences_train = ilasp.preferencesFromFileSpacesAndSign("PCAexperiment/users_new_version_second/zero/train/105Couples/user" + str(USER) + ".txt")
