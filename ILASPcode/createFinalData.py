    ...
    for max_v in max_v_list:
        for max_p in max_p_list:
            for choice in choices:
                ...
                for USER in USERS:
                    if int(choice) == 0:
                        output_train_data_dir = "./Data17Component2Std/final/users/no_zero/train/105Couples/User" + str(USER) + "/trainFiles/"
                        output_test_data_dir = "./Data17Component2Std/final/users/no_zero/test/105Couples/User" + str(USER) + "/testFiles/"
                        output_dir_for_train_data_dir = "./Data17Component2Std/final/users/no_zero/train/105Couples/User" + str(USER) + "/outputTrain/"
                        output_dir_for_test_data_dir = "./Data17Component2Std/final/users/no_zero/test/105Couples/User" + str(USER) + "/outputTest/"
                        preferences_train = ilasp.preferencesFromFileSpacesAndSign("Data17Component2Std/users_new_version_second/no_zero/train/105Couples/user" + str(USER) + ".txt")
                        preferences_test = ilasp.preferencesFromFileSpacesAndSign("Data17Component2Std/users_new_version_second/no_zero/test/105Couples/user" + str(USER) + ".txt")
                    else:
                        output_train_data_dir = "./Data17Component2Std/final/users/zero/train/105Couples/User" + str(USER) + "/trainFiles/"
                        output_test_data_dir = "./Data17Component2Std/final/users/zero/test/105Couples/User" + str(USER) + "/testFiles/"
                        output_dir_for_train_data_dir = "./Data17Component2Std/final/users/zero/train/105Couples/User" + str(USER) + "/outputTrain/"
                        output_dir_for_test_data_dir = "./Data17Component2Std/final/users/zero/test/105Couples/User" + str(USER) + "/outputTest/"
                        preferences_train = ilasp.preferencesFromFileSpacesAndSign("Data17Component2Std/users_new_version_second/zero/train/105Couples/user" + str(USER) + ".txt")
                        preferences_test = ilasp.preferencesFromFileSpacesAndSign("Data17Component2Std/users_new_version_second/zero/test/105Couples/user" + str(USER) + ".txt")
