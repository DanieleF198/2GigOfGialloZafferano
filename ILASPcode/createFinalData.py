    ...
    for max_v in max_v_list:
        for max_p in max_p_list:
            for choice in choices:
                ...
                for USER in USERS:
                    if int(choice) == 0:
                        output_train_data_dir = "./Data/final_original/users/no_zero/train/150Couples/User" + str(USER) + "/trainFiles/"
                        output_test_data_dir = "./Data/final_original/users/no_zero/test/50Couples/User" + str(USER) + "/testFiles/"
                        output_dir_for_train_data_dir = "./Data/final_original/users/no_zero/train/150Couples/User" + str(USER) + "/outputTrain/"
                        output_dir_for_test_data_dir = "./Data/final_original/users/no_zero/test/50Couples/User" + str(USER) + "/outputTest/"
                        preferences_train = ilasp.preferencesFromFileSpacesAndSign("Data/users_original/no_zero/train/150Couples/user" + str(USER) + ".txt")
                        preferences_test = ilasp.preferencesFromFileSpacesAndSign("Data/users_original/no_zero/test/50Couples/user" + str(USER) + ".txt")
                    else:
                        output_train_data_dir = "./Data/final_original/users/zero/train/150Couples/User" + str(USER) + "/trainFiles/"
                        output_test_data_dir = "./Data/final_original/users/zero/test/50Couples/User" + str(USER) + "/testFiles/"
                        output_dir_for_train_data_dir = "./Data/final_original/users/zero/train/150Couples/User" + str(USER) + "/outputTrain/"
                        output_dir_for_test_data_dir = "./Data/final_original/users/zero/test/50Couples/User" + str(USER) + "/outputTest/"
                        preferences_train = ilasp.preferencesFromFileSpacesAndSign("Data/users_original/zero/train/150Couples/user" + str(USER) + ".txt")
                        preferences_test = ilasp.preferencesFromFileSpacesAndSign("Data/users_original/zero/test/50Couples/user" + str(USER) + ".txt")
