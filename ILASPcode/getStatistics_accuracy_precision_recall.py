...
data_45_couples_no_zeros = np.zeros((54, 5, 4), dtype='float32')
data_105_couples_no_zeros = np.zeros((54, 5, 4), dtype='float32')
data_210_couples_no_zeros = np.zeros((54, 5, 4), dtype='float32')
...
for choice in choices:
    ...
    print("mean number of wc = " + str(mean_wc_numer_case45))
    print("")
    ...
    print("mean number of wc = " + str(mean_wc_numer_case105))
    print("")
