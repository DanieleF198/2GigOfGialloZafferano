...
for USER in list_of_user:
    for TrainCouple in TrainCouples:
        for std in stds:
            ...
            no_zero_data_dir = "./Data17Component2Std/final/users/no_zero/train/" + str(TrainCouple) + "Couples_gauss_std" + str(std) + "/"
            zero_data_dir = "./Data17Component2Std/final/users/zero/train/" + str(TrainCouple) + "Couples_gauss_std" + str(std) + "/"
