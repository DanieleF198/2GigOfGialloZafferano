...
for choice in choices:
    ...
    with open(path, 'w+', encoding='UTF8') as f_output:
        ...
        for COUPLE in COUPLES:
            ...
            for USER in USERS:
                if int(choice) == 0:
                    output_train_data_dir = "./Data17Component2Std/users/no_zero/train/" + str(COUPLE) + "Couples/"
                    output_dir_for_train_data_dir = "./Data17Component2Std/final/users/no_zero/train/" + str(COUPLE) + "Couples/User" + str(USER) + "/outputTrain/"
                    output_test_data_dir = "./Data17Component2Std/final/users/no_zero/test/105Couples/User" + str(USER) + "/testFiles/"
                else:
                    output_train_data_dir = "./Data17Component2Std/users/zero/train/" + str(COUPLE) + "Couples/"
                    output_dir_for_train_data_dir = "./Data17Component2Std/final/users/zero/train/" + str(COUPLE) + "Couples/User" + str(USER) + "/outputTrain/"
