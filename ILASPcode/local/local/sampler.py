...
def create_samples(no_zero):
    ...
    while True:
        ...
        counter_of_couple += 1
    if no_zero:
        f_output = "Data8Component2Std/sampled-recipes-no-zero/couple.txt"
    else:
        f_output = "Data8Component2Std/sampled-recipes-zero/couple.txt"
    f = open(f_output, 'w+')
    sys.stdout = open(f_output, 'w')
...
if __name__ == '__main__':
    p_zero = Process(target=create_samples, args=(False,))
    p_no_zero = Process(target=create_samples, args=(True,))
