...
food_couple = np.zeros((len(linesOfCC)-1, 210, 2), dtype='int32')
...
couple_label = np.zeros((len(linesOfL)-1, 210), dtype='int32')
...
if int(inputVar) == 1:
    ...
    betterResults = np.zeros((half, 10), dtype="float32")
