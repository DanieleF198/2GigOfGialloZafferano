...
def testing():
    ...
    # WARNING: the next big commented part was used to plots some result when pca = PCA() (so before understand that we use 19 components).
    ...
    # plots 2D graph with PC from 0 to 19 (PC0 - PC1, PC0 - PC2, ..., PC0 - PC19, PC1 - PC2, ..., PC17 - PC 19, PC18 - PC19)
